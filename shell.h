...
/* prototype of exit.c */
char *custom_str_copy(char *, const char *, int);
char *custom_str_concat(char *,const char *, int);
char *custom_str_find_char(char *, char);
...
/*toem_getline.c */
ssize_t getCommandChain(info_t *, char **, size_t *);
ssize_t processInput(info_t *);
